...
class BallTracker:
    ...
    def remove_wrong_detections(self , ball_positions):   
        # Implement logic to remove wrong detections based on position consistency
        ...
        for i in range(len(ball_positions)):
           ...
           if not last_good_bbox: # If the last good bbox is empty, skip to the next frame
              continue
    ...
    def interpolate_ball_positions(self, ball_positions):
        ...
        # Convert back to the original format with track_id 1
